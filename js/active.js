(function ($) {
    ...
    var proCata = $('.memeasoy-pro-catagory');
    ...
    var memeasoySearch = $('.search-nav');
    var searchClose = $('.search-close');

    memeasoySearch.on('click', function () {
    ...
    var memeasoyMobNav = $('.memeasoy-navbar-toggler');
    var navClose = $('.nav-close');

    memeasoyMobNav.on('click', function () {
